...
public class DynamoPersistenceManager extends AbstractPersistenceManager {
	public static final String DB = "DYNAMO";
	...
	public void init(Properties p) {
		...
		client = new AmazonDynamoDBClient(new BasicAWSCredentials(awsAccessKeyId, awsSecretAccessKey));
	...
	public void checkTable(String name) {
		...
		if(!tables.contains(name)) {
			/* Need PK for create		
			client.createTable(new CreateTableRequest(name, new KeySchema()));
			tables.add(name);
			*/
			throw new NotImplementedException("table " + name + " doesn't exist and can't create without PK");
		}
